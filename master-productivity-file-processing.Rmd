...
monthly_productivity_output <- productivity_data %>%
  dplyr::select(MASTER_DEPT, CPSC_SPECIALTY, MD_NAME, NPI, ADMIN_TITLE, PROV_TYPE, LATEST_HIRE_DATE, TERM_DATE, 
                CFTE_ADJ, PERIOD, 
...
ytd_period <- max(productivity_data$PERIOD)
ytd_year <- substr(ytd_period, start = 1, stop = 4)
ytd_month <- substr(ytd_period, start = 5, stop = 6)


ytd_productivity_output <- productivity_data %>%
  filter(MONTH == ytd_month) %>%
  dplyr::select(MASTER_DEPT, CPSC_SPECIALTY, NPI, PERIOD,
                CFTE_ytd, 
...
yearly_productivity_output <- productivity_data %>%
...
colnames(productivity_output_merged) <- c("MASTER_DEPT", "CPSC_SPECIALTY", "MD_NAME", "NPI", "ADMIN_TITLE", 
                                          "PROV_TYPE", "LATEST_HIRE_DATE", "TERM_DATE", 
                                          ...
                                          paste0("Adj. CFTE ", year_col_names),
                                          paste0("WRVUs ", year_col_names),
                                          paste0("WRVUs Annualized ", year_col_names),
                                          paste0("WRVUs Annualized Adj. CFTE ", year_col_names),
...
productivity_output_merged <- productivity_output_merged %>%
  arrange(MASTER_DEPT, CPSC_SPECIALTY, MD_NAME)
...
percent_format = createStyle(numFmt="#,##0%", textDecoration = "bold")
...
orangeStyle <- createStyle(fontColour = "#FF9900")
greenStyle <- createStyle(fontColour = "#00B050")
...
addStyle(wb, 1, provStyle, rows = row_start, cols = 1:(col_start-1))

#### Monthly Data Section
addStyle(wb, 1, cfteStyle, 
         rows = row_start, 
         cols = col_start:(col_start+(month_col_num*1)-1))
...
# groupColumns(wb, 1, cols = c(col_start:(col_start+(month_col_num*1)-1)), hidden = TRUE)
...
# groupColumns(wb, 1, cols = c((col_start+month_col_num*1):(col_start+(month_col_num*2)-1)), hidden = TRUE)
...
addStyle(wb, 1, percent_format, 
         rows = (row_start+1):(row_start+nrow(productivity_output_merged)), 
         cols = (col_start+month_col_num*3):(col_start+(month_col_num*4)-1), gridExpand = TRUE)
...
# groupColumns(wb, 1, cols = c((col_start+month_col_num*3):(col_start+(month_col_num*4)-1)), hidden = TRUE)
...
addStyle(wb, 1, cfteStyle, 
         rows = row_start, 
         cols = (col_start+(month_col_num*4)+(year_col_num*7)):(col_start+(month_col_num*4)+(year_col_num*8)-1))
addStyle(wb, 1, decimal_format, 
         rows = (row_start+1):(row_start+nrow(productivity_output_merged)), 
         cols = (col_start+(month_col_num*4)+(year_col_num*7)):(col_start+(month_col_num*4)+(year_col_num*8)-1), gridExpand = TRUE)


addStyle(wb, 1, wRVUsStyle, 
         rows = row_start, 
         cols = (col_start+(month_col_num*4)+(year_col_num*8)):(col_start+(month_col_num*4)+(year_col_num*9)-1))
addStyle(wb, 1, number_format, 
         rows = (row_start+1):(row_start+nrow(productivity_output_merged)), 
         cols = (col_start+(month_col_num*4)+(year_col_num*8)):(col_start+(month_col_num*4)+(year_col_num*9)-1), gridExpand = TRUE)


addStyle(wb, 1, wRVUsStyle, 
         rows = row_start, 
         cols = (col_start+(month_col_num*4)+(year_col_num*9)):(col_start+(month_col_num*4)+(year_col_num*10)-1))
addStyle(wb, 1, number_format, 
         rows = (row_start+1):(row_start+nrow(productivity_output_merged)), 
         cols = (col_start+(month_col_num*4)+(year_col_num*9)):(col_start+(month_col_num*4)+(year_col_num*10)-1), gridExpand = TRUE)


addStyle(wb, 1, wRVUsStyle, 
         rows = row_start, 
         cols = (col_start+(month_col_num*4)+(year_col_num*10)):(col_start+(month_col_num*4)+(year_col_num*11)-1))
addStyle(wb, 1, number_format, 
         rows = (row_start+1):(row_start+nrow(productivity_output_merged)), 
         cols = (col_start+(month_col_num*4)+(year_col_num*10)):(col_start+(month_col_num*4)+(year_col_num*11)-1), gridExpand = TRUE)


addStyle(wb, 1, collectionsStyle, 
         rows = row_start, 
         cols = (col_start+(month_col_num*4)+(year_col_num*11)):(col_start+(month_col_num*4)+(year_col_num*12)-1))
addStyle(wb, 1, dollar_format, 
         rows = (row_start+1):(row_start+nrow(productivity_output_merged)), 
         cols = (col_start+(month_col_num*4)+(year_col_num*11)):(col_start+(month_col_num*4)+(year_col_num*12)-1), gridExpand = TRUE)


addStyle(wb, 1, collectionsStyle, 
         rows = row_start, 
         cols = (col_start+(month_col_num*4)+(year_col_num*12)):(col_start+(month_col_num*4)+(year_col_num*13)-1))
addStyle(wb, 1, dollar_format, 
         rows = (row_start+1):(row_start+nrow(productivity_output_merged)), 
         cols = (col_start+(month_col_num*4)+(year_col_num*12)):(col_start+(month_col_num*4)+(year_col_num*13)-1), gridExpand = TRUE)


addStyle(wb, 1, productivityStyle, 
         rows = row_start, 
         cols = (col_start+(month_col_num*4)+(year_col_num*13)):(col_start+(month_col_num*4)+(year_col_num*14)-1))
addStyle(wb, 1, percent_format, 
         rows = (row_start+1):(row_start+nrow(productivity_output_merged)), 
         cols = (col_start+(month_col_num*4)+(year_col_num*13)):(col_start+(month_col_num*4)+(year_col_num*14)-1), gridExpand = TRUE)
...
<!-- saveWorkbook(wb, "/nfs/data/Applications/Ambulatory/Master Productivity File Prototype.xlsx", overwrite = T) -->
